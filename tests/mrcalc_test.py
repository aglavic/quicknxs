...
class FitTest(unittest.TestCase):
  ...
  def test_absolute(self):
    ...
    self.assertAlmostEqual(res[0], 1e4, msg='I', delta=1.)
    self.assertAlmostEqual(res[1], 249.5, msg='x0', delta=0.1)
    self.assertAlmostEqual(res[2], 249.5, msg='sigma', delta=0.1)
  ...
  def test_left_right(self):
    ...
    self.assertAlmostEqual(res1[0], res2[0], msg='I left vs. right', places=8)
    self.assertAlmostEqual(res1[1], res2[1], msg='x0 left vs. right', places=8)
    self.assertAlmostEqual(res1[2], res2[2], msg='sigma left vs. right', places=8)
