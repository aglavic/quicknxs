...
class InitFileMenu(object):
	...
	def init_action(self):
		...
		_action6.triggered.connect(self.mainGui.launch_config_file1)
		_action6.setCheckable(True)
		_action6.setShortcut(QtGui.QKeySequence(QtCore.Qt.META + QtCore.Qt.Key_0))
		...
		_action7.setShortcut(QtGui.QKeySequence(QtCore.Qt.META + QtCore.Qt.Key_1))
		_action7.triggered.connect(self.mainGui.launch_config_file2)
		_action7.setVisible(False)
		self.mainGui.ui.menuFile.addAction(_action7)

		_action8 = QtGui.QAction('', self.mainGui)
		_action8.triggered.connect(self.mainGui.launch_config_file3)
		_action8.setShortcut(QtGui.QKeySequence(QtCore.Qt.META + QtCore.Qt.Key_2))
		...
		_action9.triggered.connect(self.mainGui.launch_config_file4)
		_action9.setShortcut(QtGui.QKeySequence(QtCore.Qt.META + QtCore.Qt.Key_3))
		...
		_action10.triggered.connect(self.mainGui.launch_config_file5)
