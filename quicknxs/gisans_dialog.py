...
#
# Created: Thu Apr  9 12:55:41 2015
...
class Ui_Dialog(object):
  def setupUi(self, Dialog):
    ...
    self.usePf = QtGui.QCheckBox(self.widget)
    self.usePf.setObjectName(_fromUtf8("usePf"))
  ...
  def retranslateUi(self, Dialog):
    ...
    self.usePf.setText(_translate("Dialog", "/pf", None))
