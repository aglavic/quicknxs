...
#
# Created: Wed Jul 24 17:08:20 2013
...
class Ui_Dialog(object):
  ...
  def retranslateUi(self, Dialog):
    ...
    self.emailZIP.setText(_translate("Dialog", "ZIP Files", None))
    self.emailPlots.setText(_translate("Dialog", "Only Plots", None))
    self.emailAll.setText(_translate("Dialog", "All", None))
    self.emailSend.setText(_translate("Dialog", "Send email with result files", None))
    self.emailData.setText(_translate("Dialog", "Only Data", None))
