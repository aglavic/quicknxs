...
#
# Created: Fri Dec 19 15:43:40 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        QtCore.QObject.connect(self.peak1_2, QtCore.SIGNAL("editingFinished()"), Dialog.manual_input_peak1_2)
        QtCore.QObject.connect(self.peak2_2, QtCore.SIGNAL("editingFinished()"), Dialog.manual_input_peak2_2)
        QtCore.QObject.connect(self.back1, QtCore.SIGNAL("editingFinished()"), Dialog.manual_input_back1)
        QtCore.QObject.connect(self.back1_2, QtCore.SIGNAL("editingFinished()"), Dialog.manual_input_back1_2)
        QtCore.QObject.connect(self.back2, QtCore.SIGNAL("editingFinished()"), Dialog.manual_input_back2)
        QtCore.QObject.connect(self.back2_2, QtCore.SIGNAL("editingFinished()"), Dialog.manual_input_back2_2)
