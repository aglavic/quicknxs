...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    QtCore.QObject.connect(self.actionClear_Normalizations, QtCore.SIGNAL(_fromUtf8("activated()")), MainWindow.clearNormList)
    ...
    MainWindow.setTabOrder(self.tthPhi, self.directPixelOverwrite)
    MainWindow.setTabOrder(self.directPixelOverwrite, self.dangle0Overwrite)
    MainWindow.setTabOrder(self.dangle0Overwrite, self.fanReflectivity)
    ...
    MainWindow.setTabOrder(self.pushButton, self.addStitchPoints)
    MainWindow.setTabOrder(self.addStitchPoints, self.xprojUseQuantiles)
  ...
  def retranslateUi(self, MainWindow):
    ...
    self.selectedChannel.setToolTip(QtGui.QApplication.translate("MainWindow", "Select the channel for the overview. If channel is not in file, the first will be used.", None, QtGui.QApplication.UnicodeUTF8))
