...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    icon4 = QtGui.QIcon()
    icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/General/reduce.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    self.actionReduce.setIcon(icon4)
    ...
    icon5 = QtGui.QIcon()
    icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/General/fitXPos.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    self.actionRefineX.setIcon(icon5)
    ...
    self.mainToolbar.addAction(self.actionRefineX)
    self.mainToolbar.addSeparator()
  ...
  def retranslateUi(self, MainWindow):
    ...
    self.actionRefineX.setToolTip(QtGui.QApplication.translate("MainWindow", "Fit the x-position with a Gaussian (Ctrl+F)", None, QtGui.QApplication.UnicodeUTF8))
