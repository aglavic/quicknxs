...
class Ui_Dialog(object):
  ...
  def retranslateUi(self, Dialog):
    ...
    self.groupBox.setTitle(QtGui.QApplication.translate("Dialog", "States to Extract", None, QtGui.QApplication.UnicodeUTF8))
    self.export_0.setText(QtGui.QApplication.translate("Dialog", " X / + / ++/0V", None, QtGui.QApplication.UnicodeUTF8))
    self.export_3.setText(QtGui.QApplication.translate("Dialog", "- / --/+V", None, QtGui.QApplication.UnicodeUTF8))
    self.export_1.setText(QtGui.QApplication.translate("Dialog", "+-/-V", None, QtGui.QApplication.UnicodeUTF8))
    self.export_2.setText(QtGui.QApplication.translate("Dialog", "-+", None, QtGui.QApplication.UnicodeUTF8))
