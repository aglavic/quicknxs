...
# Form implementation generated from reading ui file 'designer/docked_interface.ui'
#
# Created: Thu Jan 16 14:15:51 2014
...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.selectedChannel5 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel5.setObjectName(_fromUtf8("selectedChannel5"))
    self.gridLayout_7.addWidget(self.selectedChannel5, 1, 1, 1, 1)
    self.selectedChannel7 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel7.setObjectName(_fromUtf8("selectedChannel7"))
    ...
    self.selectedChannel4 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel4.setObjectName(_fromUtf8("selectedChannel4"))
    ...
    self.selectedChannel6 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel6.setObjectName(_fromUtf8("selectedChannel6"))
    self.gridLayout_7.addWidget(self.selectedChannel6, 1, 2, 1, 1)
    self.selectedChannel8 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel8.setObjectName(_fromUtf8("selectedChannel8"))
    self.gridLayout_7.addWidget(self.selectedChannel8, 2, 0, 1, 1)
    self.selectedChannel9 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel9.setObjectName(_fromUtf8("selectedChannel9"))
    self.gridLayout_7.addWidget(self.selectedChannel9, 2, 1, 1, 1)
    self.selectedChannel10 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel10.setObjectName(_fromUtf8("selectedChannel10"))
    self.gridLayout_7.addWidget(self.selectedChannel10, 2, 2, 1, 1)
    self.selectedChannel11 = QtGui.QRadioButton(self.frame_2)
    self.selectedChannel11.setObjectName(_fromUtf8("selectedChannel11"))
    ...
    self.reduceLastButton.setObjectName(_fromUtf8("reduceLastButton"))
    ...
    self.verticalLayout_5.addWidget(self.plotTab)
    ...
    self.x_project = MPLWidget(self.dockWidgetContents)
    ...
    self.verticalLayout_10.addWidget(self.x_project)
    ...
    self.verticalLayout_18 = QtGui.QVBoxLayout(self.dockWidgetContents_2)
    self.verticalLayout_18.setMargin(0)
    self.verticalLayout_18.setObjectName(_fromUtf8("verticalLayout_18"))
    self.y_project = MPLWidget(self.dockWidgetContents_2)
    self.y_project.setMinimumSize(QtCore.QSize(150, 150))
    self.y_project.setObjectName(_fromUtf8("y_project"))
    self.verticalLayout_18.addWidget(self.y_project)
    ...
    self.verticalLayout_25 = QtGui.QVBoxLayout(self.dockWidgetContents_3)
    self.verticalLayout_25.setMargin(0)
    self.verticalLayout_25.setObjectName(_fromUtf8("verticalLayout_25"))
    self.refl = MPLWidget(self.dockWidgetContents_3)
    sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(0)
    ...
    self.verticalLayout_25.addWidget(self.refl)
    ...
    self.gridLayout_12 = QtGui.QGridLayout(self.dockWidgetContents_4)
    ...
    self.gridLayout_12.addWidget(self.label_5, 4, 1, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.rangeStart, 5, 1, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.rangeEnd, 5, 2, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.refScale, 4, 2, 1, 1)
    self.bgActive = QtGui.QCheckBox(self.dockWidgetContents_4)
    ...
    self.gridLayout_12.addWidget(self.bgActive, 3, 0, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.bgCenter, 3, 1, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.bgWidth, 3, 2, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.refYPos, 1, 1, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.refYWidth, 1, 2, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.label_20, 5, 0, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.refXPos, 2, 1, 1, 1)
    ...
    self.gridLayout_12.addWidget(self.refXWidth, 2, 2, 1, 1)
    spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
    self.gridLayout_12.addItem(spacerItem, 6, 1, 1, 1)
    ...
    self.gridLayout_14 = QtGui.QGridLayout(self.dockWidgetContents_5)
    ...
    self.label_30 = QtGui.QLabel(self.dockWidgetContents_5)
    self.label_30.setMinimumSize(QtCore.QSize(82, 0))
    self.label_30.setObjectName(_fromUtf8("label_30"))
    self.gridLayout_14.addWidget(self.label_30, 2, 0, 1, 1)
    self.trustDANGLE = QtGui.QRadioButton(self.dockWidgetContents_5)
    ...
    self.gridLayout_14.addWidget(self.trustDANGLE, 2, 1, 1, 1)
    self.label_19 = QtGui.QLabel(self.dockWidgetContents_5)
    self.label_19.setObjectName(_fromUtf8("label_19"))
    self.gridLayout_14.addWidget(self.label_19, 1, 0, 1, 1)
    self.trustSANGLE = QtGui.QRadioButton(self.dockWidgetContents_5)
    self.trustSANGLE.setMinimumSize(QtCore.QSize(76, 0))
    self.trustSANGLE.setObjectName(_fromUtf8("trustSANGLE"))
    self.gridLayout_14.addWidget(self.trustSANGLE, 2, 2, 1, 1)
    self.label_36 = QtGui.QLabel(self.dockWidgetContents_5)
    self.label_36.setObjectName(_fromUtf8("label_36"))
    self.gridLayout_14.addWidget(self.label_36, 3, 0, 1, 2)
    self.directPixelOverwrite = QtGui.QDoubleSpinBox(self.dockWidgetContents_5)
    sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(0)
    ...
    self.gridLayout_14.addWidget(self.directPixelOverwrite, 0, 1, 1, 2)
    self.polynomOrder = QtGui.QSpinBox(self.dockWidgetContents_5)
    ...
    self.gridLayout_14.addWidget(self.polynomOrder, 3, 2, 1, 1)
    self.fanReflectivity = QtGui.QCheckBox(self.dockWidgetContents_5)
    self.fanReflectivity.setObjectName(_fromUtf8("fanReflectivity"))
    self.gridLayout_14.addWidget(self.fanReflectivity, 5, 0, 1, 2)
    self.dangle0Overwrite = QtGui.QLineEdit(self.dockWidgetContents_5)
    sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(0)
    ...
    self.gridLayout_14.addWidget(self.dangle0Overwrite, 1, 1, 1, 2)
    self.label_31 = QtGui.QLabel(self.dockWidgetContents_5)
    self.label_31.setObjectName(_fromUtf8("label_31"))
    self.gridLayout_14.addWidget(self.label_31, 4, 0, 1, 2)
    self.addStitchPoints = QtGui.QSpinBox(self.dockWidgetContents_5)
    self.addStitchPoints.setMaximum(20)
    self.addStitchPoints.setObjectName(_fromUtf8("addStitchPoints"))
    self.gridLayout_14.addWidget(self.addStitchPoints, 4, 2, 1, 1)
    spacerItem1 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
    self.gridLayout_14.addItem(spacerItem1, 6, 0, 1, 1)
    ...
    self.gridLayout_18 = QtGui.QGridLayout(self.dockWidgetContents_6)
    self.gridLayout_18.setMargin(0)
    self.gridLayout_18.setObjectName(_fromUtf8("gridLayout_18"))
    self.pushButton = QtGui.QPushButton(self.dockWidgetContents_6)
    self.pushButton.setObjectName(_fromUtf8("pushButton"))
    self.gridLayout_18.addWidget(self.pushButton, 4, 0, 1, 1)
    self.label_26 = QtGui.QLabel(self.dockWidgetContents_6)
    self.label_26.setObjectName(_fromUtf8("label_26"))
    self.gridLayout_18.addWidget(self.label_26, 1, 0, 1, 1)
    self.label_24 = QtGui.QLabel(self.dockWidgetContents_6)
    self.label_24.setObjectName(_fromUtf8("label_24"))
    self.gridLayout_18.addWidget(self.label_24, 0, 0, 1, 1)
    self.pfMaxWidth = QtGui.QDoubleSpinBox(self.dockWidgetContents_6)
    ...
    self.gridLayout_18.addWidget(self.pfMaxWidth, 2, 1, 1, 1)
    self.pfMinWidth = QtGui.QDoubleSpinBox(self.dockWidgetContents_6)
    self.pfMinWidth.setDecimals(1)
    self.pfMinWidth.setObjectName(_fromUtf8("pfMinWidth"))
    self.gridLayout_18.addWidget(self.pfMinWidth, 1, 1, 1, 1)
    self.label_23 = QtGui.QLabel(self.dockWidgetContents_6)
    self.label_23.setObjectName(_fromUtf8("label_23"))
    self.gridLayout_18.addWidget(self.label_23, 3, 0, 1, 1)
    self.pfRidgeLength = QtGui.QSpinBox(self.dockWidgetContents_6)
    self.pfRidgeLength.setProperty("value", 15)
    self.pfRidgeLength.setObjectName(_fromUtf8("pfRidgeLength"))
    self.gridLayout_18.addWidget(self.pfRidgeLength, 3, 1, 1, 1)
    self.label_25 = QtGui.QLabel(self.dockWidgetContents_6)
    self.label_25.setObjectName(_fromUtf8("label_25"))
    self.gridLayout_18.addWidget(self.label_25, 2, 0, 1, 1)
    self.pfSNR = QtGui.QDoubleSpinBox(self.dockWidgetContents_6)
    ...
    self.gridLayout_18.addWidget(self.pfSNR, 0, 1, 1, 1)
    spacerItem2 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
    self.gridLayout_18.addItem(spacerItem2, 5, 0, 1, 1)
    ...
    self.gridLayout_19 = QtGui.QGridLayout(self.dockWidgetContents_7)
    self.gridLayout_19.setMargin(0)
    self.gridLayout_19.setObjectName(_fromUtf8("gridLayout_19"))
    self.logarithmic_y = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.logarithmic_y.setChecked(True)
    self.logarithmic_y.setObjectName(_fromUtf8("logarithmic_y"))
    self.gridLayout_19.addWidget(self.logarithmic_y, 1, 1, 1, 1)
    self.tthPhi = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.tthPhi.setObjectName(_fromUtf8("tthPhi"))
    self.gridLayout_19.addWidget(self.tthPhi, 3, 1, 1, 1)
    self.logarithmic_colorscale = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.logarithmic_colorscale.setChecked(True)
    self.logarithmic_colorscale.setObjectName(_fromUtf8("logarithmic_colorscale"))
    self.gridLayout_19.addWidget(self.logarithmic_colorscale, 1, 0, 1, 1)
    self.xLamda = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.xLamda.setObjectName(_fromUtf8("xLamda"))
    self.gridLayout_19.addWidget(self.xLamda, 2, 1, 1, 1)
    self.show_colorbars = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.show_colorbars.setObjectName(_fromUtf8("show_colorbars"))
    self.gridLayout_19.addWidget(self.show_colorbars, 0, 0, 1, 1)
    self.hide_plots = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.hide_plots.setObjectName(_fromUtf8("hide_plots"))
    self.gridLayout_19.addWidget(self.hide_plots, 2, 0, 1, 1)
    self.normalizeXTof = QtGui.QCheckBox(self.dockWidgetContents_7)
    self.normalizeXTof.setObjectName(_fromUtf8("normalizeXTof"))
    self.gridLayout_19.addWidget(self.normalizeXTof, 3, 0, 1, 1)
    self.color_selector = QtGui.QComboBox(self.dockWidgetContents_7)
    ...
    self.color_selector.addItem(_fromUtf8(""))
    self.color_selector.addItem(_fromUtf8(""))
    self.gridLayout_19.addWidget(self.color_selector, 0, 1, 1, 1)
    ...
    self.verticalLayout_2 = QtGui.QVBoxLayout(self.dockWidgetContents_8)
    ...
    self.label_28 = QtGui.QLabel(self.dockWidgetContents_8)
    self.label_28.setObjectName(_fromUtf8("label_28"))
    self.horizontalLayout_12.addWidget(self.label_28)
    self.numberSearchEntry = QtGui.QLineEdit(self.dockWidgetContents_8)
    ...
    self.histogramActive = QtGui.QRadioButton(self.dockWidgetContents_8)
    ...
    self.eventActive = QtGui.QRadioButton(self.dockWidgetContents_8)
    self.eventActive.setObjectName(_fromUtf8("eventActive"))
    self.horizontalLayout_11.addWidget(self.eventActive)
    self.oldFormatActive = QtGui.QRadioButton(self.dockWidgetContents_8)
    ...
    self.eventModeEntries = QtGui.QWidget(self.dockWidgetContents_8)
    ...
    self.verticalLayout_2.addWidget(self.eventModeEntries)
    self.file_list = QtGui.QListWidget(self.dockWidgetContents_8)
    sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(1)
    ...
    self.verticalLayout_6 = QtGui.QVBoxLayout(self.dockWidgetContents_9)
    self.verticalLayout_6.setMargin(0)
    self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
    self.frame_5 = QtGui.QFrame(self.dockWidgetContents_9)
    ...
    self.verticalLayout_22 = QtGui.QVBoxLayout(self.dockWidgetContents_10)
    self.verticalLayout_22.setMargin(0)
    self.verticalLayout_22.setObjectName(_fromUtf8("verticalLayout_22"))
    self.widget_8 = QtGui.QWidget(self.dockWidgetContents_10)
    ...
    self.datasetLambda = QtGui.QLabel(self.widget_8)
    ...
    self.dockWidget_11 = QtGui.QDockWidget(MainWindow)
    self.dockWidget_11.setObjectName(_fromUtf8("dockWidget_11"))
    self.dockWidgetContents_11 = QtGui.QWidget()
    self.dockWidgetContents_11.setObjectName(_fromUtf8("dockWidgetContents_11"))
    self.verticalLayout_23 = QtGui.QVBoxLayout(self.dockWidgetContents_11)
    self.verticalLayout_23.setMargin(0)
    self.verticalLayout_23.setObjectName(_fromUtf8("verticalLayout_23"))
    self.widget_7 = QtGui.QWidget(self.dockWidgetContents_11)
    ...
    self.label_37 = QtGui.QLabel(self.widget_7)
    ...
    MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.dockWidget_11)
    ...
    QtCore.QObject.connect(self.reduceLastButton, QtCore.SIGNAL(_fromUtf8("pressed()")), MainWindow.quickReduce)
    QtCore.QObject.connect(self.actionQuick_Reduce, QtCore.SIGNAL(_fromUtf8("triggered()")), MainWindow.quickReduce)
    QtCore.QObject.connect(self.selectedChannel4, QtCore.SIGNAL(_fromUtf8("released()")), MainWindow.changeActiveChannel)
    QtCore.QObject.connect(self.selectedChannel5, QtCore.SIGNAL(_fromUtf8("released()")), MainWindow.changeActiveChannel)
    QtCore.QObject.connect(self.selectedChannel6, QtCore.SIGNAL(_fromUtf8("released()")), MainWindow.changeActiveChannel)
    QtCore.QObject.connect(self.selectedChannel7, QtCore.SIGNAL(_fromUtf8("released()")), MainWindow.changeActiveChannel)
    QtCore.QObject.connect(self.selectedChannel8, QtCore.SIGNAL(_fromUtf8("released()")), MainWindow.changeActiveChannel)
    ...
    MainWindow.setTabOrder(self.eventSplitIndex, self.plotTab)
  ...
  def retranslateUi(self, MainWindow):
    MainWindow.setWindowTitle(_translate("MainWindow", "QuickNXS", None))
    self.currentChannel.setToolTip(_translate("MainWindow", "Displays information about the dataset selected at the moment", None))
    self.currentChannel.setText(_translate("MainWindow", "Dataset information will be displayed here after loading", None))
    self.label_7.setToolTip(_translate("MainWindow", "A list of files selected fro normalization", None))
    self.label_7.setText(_translate("MainWindow", "Direct Beam Runs:", None))
    self.normalizationLabel.setToolTip(_translate("MainWindow", "A list of files selected fro normalization", None))
    self.normalizationLabel.setText(_translate("MainWindow", "Unset", None))
    self.selectedChannel0.setText(_translate("MainWindow", "++", None))
    self.selectedChannel5.setText(_translate("MainWindow", "--", None))
    self.selectedChannel7.setText(_translate("MainWindow", "-+", None))
    self.selectedChannel1.setText(_translate("MainWindow", "--", None))
    self.selectedChannel4.setText(_translate("MainWindow", "++", None))
    self.selectedChannel2.setText(_translate("MainWindow", "+-", None))
    self.selectedChannel3.setText(_translate("MainWindow", "-+", None))
    self.selectedChannel6.setText(_translate("MainWindow", "+-", None))
    self.selectedChannel8.setText(_translate("MainWindow", "++", None))
    self.selectedChannel9.setText(_translate("MainWindow", "--", None))
    self.selectedChannel10.setText(_translate("MainWindow", "+-", None))
    self.selectedChannel11.setText(_translate("MainWindow", "-+", None))
    item = self.reductionTable.horizontalHeaderItem(0)
    item.setText(_translate("MainWindow", "Run No.", None))
    item.setToolTip(_translate("MainWindow", "File Number", None))
    item = self.reductionTable.horizontalHeaderItem(1)
    item.setText(_translate("MainWindow", "I0", None))
    item.setToolTip(_translate("MainWindow", "Scaling Factor", None))
    item = self.reductionTable.horizontalHeaderItem(2)
    item.setText(_translate("MainWindow", "NL", None))
    item.setToolTip(_translate("MainWindow", "Points cut from low Q side", None))
    item = self.reductionTable.horizontalHeaderItem(3)
    item.setText(_translate("MainWindow", "NR", None))
    item.setToolTip(_translate("MainWindow", "Points cut from high Q side", None))
    item = self.reductionTable.horizontalHeaderItem(4)
    item.setText(_translate("MainWindow", "x0", None))
    item.setToolTip(_translate("MainWindow", "Center X-Pixel of Window for Reflectivity", None))
    item = self.reductionTable.horizontalHeaderItem(5)
    item.setText(_translate("MainWindow", "xw", None))
    item.setToolTip(_translate("MainWindow", "Width in X-Pixels of Window for Reflectivity", None))
    item = self.reductionTable.horizontalHeaderItem(6)
    item.setText(_translate("MainWindow", "y0", None))
    item.setToolTip(_translate("MainWindow", "Center Y-Pixel of Window for Reflectivity", None))
    item = self.reductionTable.horizontalHeaderItem(7)
    item.setText(_translate("MainWindow", "yw", None))
    item.setToolTip(_translate("MainWindow", "Width in Y-Pixels of Window for Reflectivity", None))
    item = self.reductionTable.horizontalHeaderItem(8)
    item.setText(_translate("MainWindow", "bg0", None))
    item.setToolTip(_translate("MainWindow", "Background Region Center", None))
    item = self.reductionTable.horizontalHeaderItem(9)
    item.setText(_translate("MainWindow", "bgw", None))
    item.setToolTip(_translate("MainWindow", "Background Region Width", None))
    item = self.reductionTable.horizontalHeaderItem(10)
    item.setText(_translate("MainWindow", "DPix", None))
    item.setToolTip(_translate("MainWindow", "DirectPixel", None))
    item = self.reductionTable.horizontalHeaderItem(11)
    item.setText(_translate("MainWindow", "TTH", None))
    item.setToolTip(_translate("MainWindow", "DANGLE-DANGLE0", None))
    item = self.reductionTable.horizontalHeaderItem(12)
    item.setText(_translate("MainWindow", "Dir. Run", None))
    item.setToolTip(_translate("MainWindow", "The normalization file used for this dataset", None))
    self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Data", None))
    self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "A list of datasets that will be used for reduction", None))
    item = self.normalizeTable.horizontalHeaderItem(0)
    item.setText(_translate("MainWindow", "Run No.", None))
    item.setToolTip(_translate("MainWindow", "Dataset number", None))
    item = self.normalizeTable.horizontalHeaderItem(1)
    item.setText(_translate("MainWindow", "λ", None))
    item.setToolTip(_translate("MainWindow", "Central Wavelength", None))
    item = self.normalizeTable.horizontalHeaderItem(2)
    item.setText(_translate("MainWindow", "x0", None))
    item.setToolTip(_translate("MainWindow", "X-Center of extraction window", None))
    item = self.normalizeTable.horizontalHeaderItem(3)
    item.setText(_translate("MainWindow", "xw", None))
    item.setToolTip(_translate("MainWindow", "X-Width of extraction window", None))
    item = self.normalizeTable.horizontalHeaderItem(4)
    item.setText(_translate("MainWindow", "y0", None))
    item.setToolTip(_translate("MainWindow", "Y-Center of extraction window", None))
    item = self.normalizeTable.horizontalHeaderItem(5)
    item.setText(_translate("MainWindow", "yw", None))
    item.setToolTip(_translate("MainWindow", "Y-Width of extraction window", None))
    item = self.normalizeTable.horizontalHeaderItem(6)
    item.setText(_translate("MainWindow", "bg0", None))
    item.setToolTip(_translate("MainWindow", "Background X-Center", None))
    item = self.normalizeTable.horizontalHeaderItem(7)
    item.setText(_translate("MainWindow", "bgw", None))
    item.setToolTip(_translate("MainWindow", "Background X-width", None))
    self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Direct Beam", None))
    self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "A list of datasets available for wavelength normalization", None))
    self.reduceButton.setText(_translate("MainWindow", "Reduce...", None))
    self.reduceLastButton.setText(_translate("MainWindow", "Quick-Reduce (use last options)", None))
    ...
    self.plotTab.setTabText(self.plotTab.indexOf(self.XY_Tab), _translate("MainWindow", "X-Y", None))
    self.plotTab.setTabToolTip(self.plotTab.indexOf(self.XY_Tab), _translate("MainWindow", "X-Y intensity maps for all channels in this file", None))
    self.plotTab.setTabText(self.plotTab.indexOf(self.XTof_Tab), _translate("MainWindow", "X-ToF", None))
    self.plotTab.setTabToolTip(self.plotTab.indexOf(self.XTof_Tab), _translate("MainWindow", "X-ToF intensity maps for all channels in this file", None))
    self.kizmkfzVSqz.setText(_translate("MainWindow", "(ki_z-kf_z) VS. Qz", None))
    self.qxVSqz.setText(_translate("MainWindow", "Qx VS. Qz", None))
    self.kizVSkfz.setText(_translate("MainWindow", "ki_z VS. kf_z", None))
    self.label_21.setText(_translate("MainWindow", "Imin 10^", None))
    self.clipOffspec.setText(_translate("MainWindow", "Clip", None))
    self.label_22.setText(_translate("MainWindow", "Imax 10^", None))
    self.plotTab.setTabText(self.plotTab.indexOf(self.OffSpec_Tab), _translate("MainWindow", "OffSpec Preview", None))
    self.plotTab.setTabToolTip(self.plotTab.indexOf(self.OffSpec_Tab), _translate("MainWindow", "Off-Specular scattering intensity preview for all files in the reduction list", None))
    self.label_16.setText(_translate("MainWindow", "Imin 10^", None))
    self.label_32.setText(_translate("MainWindow", "Imax 10^", None))
    self.plotTab.setTabText(self.plotTab.indexOf(self.gisansTab), _translate("MainWindow", "GISANS Preview", None))
    self.daslogBox.setTitle(_translate("MainWindow", "Recorded values for all Motors/Devices:", None))
    ...
    item.setText(_translate("MainWindow", "Unit", None))
    self.plotTab.setTabText(self.plotTab.indexOf(self.daslogTab), _translate("MainWindow", "DAS Logs", None))
    self.plotTab.setTabToolTip(self.plotTab.indexOf(self.daslogTab), _translate("MainWindow", "Motor and parameter log read from the file", None))
    self.plotTab.setTabText(self.plotTab.indexOf(self.compareTab), _translate("MainWindow", "Compare", None))
    ...
    self.dockWidget.setWindowTitle(_translate("MainWindow", "X-Projection", None))
    self.dockWidget_2.setWindowTitle(_translate("MainWindow", "Y-Projection", None))
    self.dockWidget_3.setWindowTitle(_translate("MainWindow", "Reflectivity", None))
    self.dockWidget_4.setWindowTitle(_translate("MainWindow", "Reflectivity Extraction (Basic)", None))
    self.label.setText(_translate("MainWindow", "Position", None))
    self.label_5.setToolTip(_translate("MainWindow", "Scaling factor for the reflectivity in powers of 10", None))
    self.label_5.setText(_translate("MainWindow", "Scale 10^", None))
    self.rangeStart.setToolTip(_translate("MainWindow", "<html><head/><body><p>Remove points from the extracted intensity on the low Q side. </p><p>Uses the full ToF range available in the file, so it is possible it does not have any effect for lower values.</p></body></html>", None))
    self.rangeEnd.setToolTip(_translate("MainWindow", "<html><head/><body><p>Remove points from the extracted intensity on the high Q side. </p><p>Uses the full ToF range available in the file, so it is possible it does not have any effect for lower values.</p></body></html>", None))
    self.label_2.setText(_translate("MainWindow", "Width", None))
    self.refScale.setToolTip(_translate("MainWindow", "Scaling factor for the reflectivity in powers of 10", None))
    self.bgActive.setText(_translate("MainWindow", "BG X", None))
    self.bgCenter.setToolTip(_translate("MainWindow", "Center of region used for extraction", None))
    self.bgWidth.setToolTip(_translate("MainWindow", "Width of region used for extraction", None))
    ...
    self.refYWidth.setToolTip(_translate("MainWindow", "Width of region used for extraction", None))
    self.label_4.setToolTip(_translate("MainWindow", "X Pixel Window", None))
    self.label_4.setText(_translate("MainWindow", "X", None))
    self.label_20.setText(_translate("MainWindow", "Cut Pts", None))
    self.refXPos.setToolTip(_translate("MainWindow", "Center of region used for extraction", None))
    self.refXWidth.setToolTip(_translate("MainWindow", "Width of region used for extraction", None))
    self.dockWidget_5.setWindowTitle(_translate("MainWindow", "Reflectivity Extraction (Advanced)", None))
    self.label_18.setToolTip(_translate("MainWindow", "<html><head/><body><p>Overwrite the direct pixel value, read from the file.</p><p>Usefull if the wrong values have been written during the measurement.</p></body></html>", None))
    self.label_18.setText(_translate("MainWindow", "Direct Pixel", None))
    self.label_30.setText(_translate("MainWindow", "Trusted Angle:", None))
    self.trustDANGLE.setText(_translate("MainWindow", "DANGLE", None))
    self.label_19.setToolTip(_translate("MainWindow", "<html><head/><body><p>Overwrite the DANGLE0 value from the datafile.</p><p>Useful if the values have not been set properly during the measurement.</p></body></html>", None))
    self.label_19.setText(_translate("MainWindow", "Dangle0", None))
    self.trustSANGLE.setText(_translate("MainWindow", "SANGLE", None))
    self.label_36.setText(_translate("MainWindow", "Stitch Polynom Order", None))
    self.directPixelOverwrite.setToolTip(_translate("MainWindow", "<html><head/><body><p>Overwrite the direct pixel value, read from the file.</p><p>Usefull if the wrong values have been written during the measurement.</p></body></html>", None))
    self.fanReflectivity.setToolTip(_translate("MainWindow", "<html><head/><body><p>Evaluate Q for each X line of the reflectivity and combine these measurements.</p><p>Can be used with a large X-width of e.g. 15 for samples scattering to a large 2θ area.</p></body></html>", None))
    self.fanReflectivity.setText(_translate("MainWindow", "\"Fan\"-Reflection", None))
    self.dangle0Overwrite.setToolTip(_translate("MainWindow", "<html><head/><body><p>Overwrite the DANGLE0 value from the datafile.</p><p>Useful if the values have not been set properly during the measurement.</p></body></html>", None))
    self.dangle0Overwrite.setText(_translate("MainWindow", "None", None))
    self.label_31.setText(_translate("MainWindow", "Stitching Add Points:", None))
    self.addStitchPoints.setToolTip(_translate("MainWindow", "When Stitching together two scans, add this amount of points from each scan to the overlap area for the fit.", None))
    self.dockWidget_6.setWindowTitle(_translate("MainWindow", "Peak Finder Algorithm", None))
    self.pushButton.setText(_translate("MainWindow", "Visualize", None))
    self.label_26.setText(_translate("MainWindow", "Min. Width", None))
    self.label_24.setText(_translate("MainWindow", "Signal/Noise", None))
    self.label_23.setText(_translate("MainWindow", "Ridge Length", None))
    self.label_25.setText(_translate("MainWindow", "Max. Width", None))
    self.dockWidget_7.setWindowTitle(_translate("MainWindow", "Plot Options", None))
    self.logarithmic_y.setToolTip(_translate("MainWindow", "Logarithmic Y-scale for the projections and reflectivity", None))
    self.logarithmic_y.setText(_translate("MainWindow", "Log Y for lines", None))
    self.tthPhi.setToolTip(_translate("MainWindow", "Replace X and Y axes by the according scattering angle for the maps", None))
    self.tthPhi.setText(_translate("MainWindow", "2θ-φ Maps", None))
    self.logarithmic_colorscale.setToolTip(_translate("MainWindow", "Logarithmic colorscale in the maps", None))
    self.logarithmic_colorscale.setText(_translate("MainWindow", "Log Colorscale", None))
    self.xLamda.setToolTip(_translate("MainWindow", "Replace ToF axis with wavelength for the maps", None))
    self.xLamda.setText(_translate("MainWindow", "X-λ Maps", None))
    self.show_colorbars.setToolTip(_translate("MainWindow", "Show a colorbar for the map plots", None))
    self.show_colorbars.setText(_translate("MainWindow", "Colorbars", None))
    self.hide_plots.setToolTip(_translate("MainWindow", "Hide empty channels in the X-Y and X-ToF tabs to make more space for the measured channels", None))
    self.hide_plots.setText(_translate("MainWindow", "Hide Empty", None))
    self.normalizeXTof.setToolTip(_translate("MainWindow", "Normalize the intensity in the X-ToF maps by the incident beam measurement", None))
    self.normalizeXTof.setText(_translate("MainWindow", "Norm. X-ToF/λ", None))
    self.color_selector.setToolTip(_translate("MainWindow", "Select the color scale from a list of presets", None))
    self.color_selector.setItemText(0, _translate("MainWindow", "default", None))
    self.color_selector.setItemText(1, _translate("MainWindow", "gist_ncar", None))
    self.color_selector.setItemText(2, _translate("MainWindow", "gist_rainbow", None))
    self.color_selector.setItemText(3, _translate("MainWindow", "jet", None))
    self.color_selector.setItemText(4, _translate("MainWindow", "hsv", None))
    self.color_selector.setItemText(5, _translate("MainWindow", "hot", None))
    self.color_selector.setItemText(6, _translate("MainWindow", "binary", None))
    self.dockWidget_8.setWindowTitle(_translate("MainWindow", "Files", None))
    self.label_28.setToolTip(_translate("MainWindow", "Search for a file by measurement number", None))
    self.label_28.setText(_translate("MainWindow", "Open Number:", None))
    self.numberSearchEntry.setToolTip(_translate("MainWindow", "Search for a file by measurement number", None))
    self.histogramActive.setText(_translate("MainWindow", "Histogram", None))
    self.eventActive.setText(_translate("MainWindow", "Event", None))
    self.oldFormatActive.setText(_translate("MainWindow", "Old", None))
    self.label_27.setToolTip(_translate("MainWindow", "The number of bins for the Time of Flight channels", None))
    self.label_27.setText(_translate("MainWindow", "Bins ", None))
    ...
    self.dockWidget_9.setWindowTitle(_translate("MainWindow", "Run Info 1", None))
    self.label_17.setToolTip(_translate("MainWindow", "Direct pixel value read from file, if overwrite is active, the read value is in brackets", None))
    self.label_17.setText(_translate("MainWindow", "Direct Pixel", None))
    self.label_11.setToolTip(_translate("MainWindow", "Detector Angle value read from file", None))
    self.label_11.setText(_translate("MainWindow", "DANGLE", None))
    self.label_15.setToolTip(_translate("MainWindow", "Two theta value calculated from file, if DANGLE0 overwrite is active, the read value is in brackets", None))
    self.label_15.setText(_translate("MainWindow", "DANGLE0", None))
    self.datasetDirectPixel.setToolTip(_translate("MainWindow", "Direct pixel value read from file, if overwrite is active, the read value is in brackets", None))
    self.datasetDangle.setToolTip(_translate("MainWindow", "Detector Angle value read from file", None))
    self.datasetDangle0.setToolTip(_translate("MainWindow", "Two theta value calculated from file, if DANGLE0 overwrite is active, the read value is in brackets", None))
    self.dockWidget_10.setWindowTitle(_translate("MainWindow", "Run Info 2", None))
    self.label_8.setToolTip(_translate("MainWindow", "Read from file", None))
    self.label_8.setText(_translate("MainWindow", "λ", None))
    self.label_12.setToolTip(_translate("MainWindow", "Sample angle read from file", None))
    self.label_12.setText(_translate("MainWindow", "SANGLE", None))
    self.datasetSangle.setToolTip(_translate("MainWindow", "Sample angle read from file", None))
    self.label_13.setToolTip(_translate("MainWindow", "Sample angle calculated from 2Θ and X-center position", None))
    self.label_13.setText(_translate("MainWindow", "SANGLE-calc", None))
    self.datasetAi.setToolTip(_translate("MainWindow", "Sample angle calculated from 2Θ and X-center position", None))
    self.datasetLambda.setToolTip(_translate("MainWindow", "Read from file", None))
    self.label_9.setToolTip(_translate("MainWindow", "Read from file", None))
    self.label_9.setText(_translate("MainWindow", "Proton Charge", None))
    self.datasetPCharge.setToolTip(_translate("MainWindow", "Read from file", None))
    self.dockWidget_11.setWindowTitle(_translate("MainWindow", "Run Info 3", None))
    self.label_10.setToolTip(_translate("MainWindow", "Read from file", None))
    self.label_10.setText(_translate("MainWindow", "Total Counts", None))
    self.datasetTotCounts.setToolTip(_translate("MainWindow", "Read from file", None))
    self.label_6.setText(_translate("MainWindow", "Counting Time", None))
    self.label_37.setText(_translate("MainWindow", "Count Rate", None))
    self.datasetROI.setToolTip(_translate("MainWindow", "Counts in the window selected for X and Y", None))
    self.label_14.setToolTip(_translate("MainWindow", "Counts in the window selected for X and Y", None))
    self.label_14.setText(_translate("MainWindow", "Counts ROI", None))
    self.actionOpen.setText(_translate("MainWindow", "Open...", None))
    self.actionOpen.setToolTip(_translate("MainWindow", "Open a new file (Ctrl+O)", None))
    self.actionOpen.setShortcut(_translate("MainWindow", "Ctrl+O", None))
    self.actionNext_File.setText(_translate("MainWindow", "Next File", None))
    self.actionNext_File.setToolTip(_translate("MainWindow", "Next file in active folder (Ctrl+D)", None))
    self.actionNext_File.setShortcut(_translate("MainWindow", "Ctrl+D", None))
    self.actionPrevious_File.setText(_translate("MainWindow", "Previous File", None))
    self.actionPrevious_File.setToolTip(_translate("MainWindow", "Previous file in current foldet (Ctrl+Shift+D)", None))
    self.actionPrevious_File.setShortcut(_translate("MainWindow", "Ctrl+Shift+D", None))
    self.actionNorm.setText(_translate("MainWindow", "Set Normalization", None))
    self.actionNorm.setToolTip(_translate("MainWindow", "Take current dataset as direct beam for wavelength normalization (Ctrl+W)", None))
    self.actionNorm.setShortcut(_translate("MainWindow", "Ctrl+W", None))
    self.actionAddPlot.setText(_translate("MainWindow", "Keep Item in List", None))
    self.actionAddPlot.setToolTip(_translate("MainWindow", "Add current dataset to data reduction list (Ctrl+Q)", None))
    self.actionAddPlot.setShortcut(_translate("MainWindow", "Ctrl+Q", None))
    self.actionClear.setText(_translate("MainWindow", "Clear List", None))
    self.actionClear.setToolTip(_translate("MainWindow", "Remove all plots from data reduction list (CTRL+SHIFT+Q)", None))
    self.actionClear.setShortcut(_translate("MainWindow", "Ctrl+Shift+Q", None))
    self.actionAdjust_Dirct_Beam.setText(_translate("MainWindow", "Adjust Dirct Beam", None))
    self.actionAdjust_Dirct_Beam.setToolTip(_translate("MainWindow", "Use active dataset to set overwrite parameters for direct pixel and Dangle0", None))
    self.actionNormalizeScaling.setText(_translate("MainWindow", "Set Scaling", None))
    self.actionNormalizeScaling.setToolTip(_translate("MainWindow", "Scale total reflection to 1/fit overlap to previous run (Ctrl+S)", None))
    self.actionNormalizeScaling.setShortcut(_translate("MainWindow", "Ctrl+S", None))
    self.actionRemove.setText(_translate("MainWindow", "Remove Line", None))
    self.actionRemove.setToolTip(_translate("MainWindow", "Remove selected plots from data reduction list", None))
    self.actionReduce.setText(_translate("MainWindow", "Reduce...", None))
    self.actionReduce.setToolTip(_translate("MainWindow", "Use the active table to extrac reduced datasets and save them", None))
    self.actionManual.setText(_translate("MainWindow", "Manual...", None))
    self.actionAbout.setText(_translate("MainWindow", "About...", None))
    self.actionAutoYLimits.setText(_translate("MainWindow", "Automatic Y Limits", None))
    self.actionAutoYLimits.setToolTip(_translate("MainWindow", "Try to find the Y region of the beam automatically", None))
    self.actionAutomaticXPeak.setText(_translate("MainWindow", "Automatic Peak Finder", None))
    self.actionAutomaticXPeak.setToolTip(_translate("MainWindow", "Find the reflected peak automatically when loading a new file", None))
    ...
    self.actionClear_Normalizations.setText(_translate("MainWindow", "Clear Normalizations", None))
    self.actionClear_Normalizations.setToolTip(_translate("MainWindow", "Remove all datasets from the direct beam list (CTRL+SHIFT+W)", None))
    self.actionClear_Normalizations.setShortcut(_translate("MainWindow", "Ctrl+Shift+W", None))
    ...
    self.actionCut_Points.setText(_translate("MainWindow", "Cut Points (L/R)", None))
    self.actionCut_Points.setToolTip(_translate("MainWindow", "Change the left and right cutoff (Cut Pts) values for the active file from the normalization intensity (Ctrl+Shift+C)", None))
    self.actionCut_Points.setShortcut(_translate("MainWindow", "Ctrl+Shift+C", None))
    self.actionAuto_Reflectivity.setText(_translate("MainWindow", "Auto Reflectivity", None))
    self.actionAuto_Reflectivity.setToolTip(_translate("MainWindow", "Start with active dataset as total reflectivity region and continue adding datasets until the incident angle gets lower than for the last dataset (Ctrl+Shift+A)", None))
    self.actionAuto_Reflectivity.setShortcut(_translate("MainWindow", "Ctrl+Shift+A", None))
    self.actionStrip_Overlap.setText(_translate("MainWindow", "Strip Overlap", None))
    self.actionStrip_Overlap.setToolTip(_translate("MainWindow", "Strip points from datasets that overlap with the subsequent dataset in the reflectivity (Ctrl+Shift+S)", None))
    self.actionStrip_Overlap.setShortcut(_translate("MainWindow", "Ctrl+Shift+S", None))
