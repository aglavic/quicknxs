...
\label{sec:quick_start}
  ...
  \subsection{Step 3: Normalize total reflection and add the first dataset}
    ...
    \includegraphics[width=115pt]{screenshots/cutpoints.png} Than activate the \textbf{Set Scaling action} \icon{totalReflection} to normalize the total reflection to one.
